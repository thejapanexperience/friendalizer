...
const API = {
  initializeFavorites () {
    axios.get(`https://xxxx.herokuapp.com/managefavorites`)
  ...
  search (pics, msgs) {
    ...
    axios.post(`https://xxxx.herokuapp.com/api/search`,{pics, msgs})
  ...
  postFavorite (favorite) {
    axios.post(`https://xxxx.herokuapp.com/managefavorites`, favorite)
  ...
  deleteFavorite (id) {
    axios.delete(`https://xxxx.herokuapp.com/managefavorites?id=${encodeURI(id)}`)
  ...
  getBusiness (id) {
    axios.get(`https://xxxx.herokuapp.com/business?id=${id}`)
  ...
  startStream (term, count, radius) {
    axios.get(`https://xxxx.herokuapp.com/search/live?term=${encodeURI(term)}&count=${count}&radius=${radius}`);
