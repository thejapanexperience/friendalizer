...
const API = {
  initializeFavorites () {
    axios.get(`https://***.herokuapp.com:443/managefavorites`)
  ...
  openSocket () {
    socket = io.connect(`https://***.herokuapp.com:443`);
  ...
  search (pics, msgs) {
    ...
    axios.post(`https://***.herokuapp.com:443/api/search`,{pics, msgs})
  ...
  postFavorite (favorite) {
    axios.post(`https://***.herokuapp.com:443/managefavorites`, favorite)
  ...
  deleteFavorite (id) {
    axios.delete(`https://***.herokuapp.com:443/managefavorites?id=${encodeURI(id)}`)
  ...
  getBusiness (id) {
    axios.get(`https://***.herokuapp.com:443/business?id=${id}`)
  ...
  startStream (term, count, radius) {
    axios.get(`https://***.herokuapp.com:443/search/live?term=${encodeURI(term)}&count=${count}&radius=${radius}`);
